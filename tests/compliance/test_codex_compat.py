...
VECTORS = ROOT / "tests" / "compliance" / "codex_compat" / "semantic_vectors.json"


class CodexCompatibilityTests(ComplianceTestCase):
    ...
    def test_session_semantics_match_codex_style_exec_and_stdin(self) -> None:
